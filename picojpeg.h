...
enum
{
   ...
   PJPG_BAD_HEIGHT,//8
   PJPG_BAD_WIDTH,//9
   PJPG_TOO_MANY_COMPONENTS,//10
   PJPG_BAD_SOF_LENGTH,//11
   PJPG_BAD_VARIABLE_MARKER,//12
   PJPG_BAD_DRI_LENGTH,//13
   PJPG_BAD_SOS_LENGTH,//14
   PJPG_BAD_SOS_COMP_ID,//15
   PJPG_W_EXTRA_BYTES_BEFORE_MARKER,//16
   PJPG_NO_ARITHMITIC_SUPPORT,//17
   PJPG_UNEXPECTED_MARKER,//18
   PJPG_NOT_JPEG,//19
