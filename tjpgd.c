...
static
const BYTE Zig[64] PROGMEM = {	/* Zigzag-order to raster-order conversion table */
...
static
const WORD Ipsf[64] PROGMEM = {	/* See also aa_idct.png */
...
#define BYTECLIP(v) pgm_read_byte(&Clip8[(UINT)(v) & 0x3FF])
static
const BYTE Clip8[1024] PROGMEM = {
	/* 0..255 */
